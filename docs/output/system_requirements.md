...
**インサイダーゲーム オンライン版**は、人気ボードゲーム「インサイダー」をブラウザベースのオンライン対戦アプリとして実現するシステムです。5〜8人のプレイヤーがDiscordなどの音声通話と連携しながら、役職の秘匿管理、タイマー制御、投票システムを活用してゲームを進行します。
...
**目標とする成果:**
- 5〜8人規模のオンライン友人グループが気軽にプレイできる環境構築
