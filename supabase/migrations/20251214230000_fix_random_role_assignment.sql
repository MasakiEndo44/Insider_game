-- Fix role assignment to be truly random each game start
-- Using clock_timestamp() to add additional entropy to random() seed
...
BEGIN
  ...
  -- Shuffle players using random() with fresh seed
